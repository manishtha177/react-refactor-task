...
export const Form: React.FC<IFormProps> = (props) => {
  ...
  const [error, setError] = useState<IFormError>({ title: false, price: false, description: false })
  ...
  return (
    <form className={styles.form} onSubmit={(event) => handleSubmit(event)}>
      ...
      />
      {error.title && <span className={styles.error}>Product Title is required</span>}
      ...
      <input
        ...
        onChange={handleChange}
      />
      {error.price && <span className={styles.error}>Product Price is required</span>}
      ...
      <textarea
        ...
        onChange={handleChange}
      />
      {error.description && <span className={styles.error}>Product Description is required</span>}
